# run with command: spark-submit TF_IDF.py
...
rawData = sc.textFile("T:\Research\Learn_Machine_Deep\Starting_Machine_DeepLearning_DataScience\Others\subset-small.tsv")
